...
const TOOL_CATALOG = [
  // Popular (pre-checked)
  { key: 'claude',      name: 'Claude Code',           path: 'CLAUDE.md',                        popular: true },
  { key: 'agents',      name: 'AGENTS.md (Universal)', path: 'AGENTS.md',                        popular: true },
  { key: 'copilot',     name: 'GitHub Copilot',        path: '.github/copilot-instructions.md',  popular: true },
  { key: 'cursor',      name: 'Cursor',                path: '.cursor/rules/standards.mdc',      popular: true },
  { key: 'windsurf',    name: 'Windsurf',              path: '.windsurf/rules/standards.md',     popular: true },
  { key: 'gemini',      name: 'Gemini CLI',            path: 'GEMINI.md',                        popular: true },
  // Other
  ...
  { key: 'junie',       name: 'JetBrains Junie',       path: '.junie/guidelines.md',             popular: false },
  { key: 'cursorrules', name: 'Cursor (legacy)',        path: '.cursorrules',                     popular: false },
  { key: 'amazonq',     name: 'Amazon Q',              path: '.amazonq/rules/standards.md',      popular: false },
  { key: 'roo',         name: 'Roo Code',              path: '.roo/rules/standards.md',          popular: false },
  { key: 'augment',     name: 'Augment',               path: '.augment/rules/standards.md',      popular: false },
  { key: 'tabnine',     name: 'Tabnine',               path: '.tabnine/guidelines/standards.md', popular: false },
  { key: 'jetbrains',   name: 'JetBrains AI',          path: '.aiassistant/rules/standards.md',  popular: false },
  { key: 'continue',    name: 'Continue.dev',          path: '.continue/rules/standards.md',     popular: false },
];
...
function promptToolSelection() {
  return new Promise((resolve) => {
    ...
    const items = TOOL_CATALOG.map(tool => ({
      ...tool,
      checked: tool.popular, // pre-check popular tools
    }));
